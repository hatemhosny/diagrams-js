...
with Diagram("Custom"):
    rabbitmq = Custom("RabbitMQ", "./rabbitmq.png")
```
...
const rabbitmq = diagram.add(Custom("RabbitMQ", "./rabbitmq.png"));
```
...
Some Python features are not yet implemented:
...
- Browser support - run directly in browsers
- SVG output - native vector graphics
- Type safety - full TypeScript support
- Cross-platform - works in Node.js, Deno, Bun, and Cloudflare Workers

## Getting Help

- [Documentation](../) - Full documentation
- [Examples](../getting-started/examples) - More examples
- [API Reference](./api) - Complete API
- [GitHub Issues](https://github.com/author/diagrams-js/issues) - Report issues
