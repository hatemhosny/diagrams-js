...
:::tip LLM-Optimized Documentation
...
diagrams-js includes skills for enhanced AI-assisted development. These skills provide specialized guidance for common tasks and help prevent common mistakes.
...
- 🤖 [TanStack Intent Skills](https://github.com/hatemhosny/diagrams-js/blob/main/.agents/INTENT.md) - AI-assisted development
