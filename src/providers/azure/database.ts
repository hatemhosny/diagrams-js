...
export function CacheForRedis(label?: string, options?: Record<string, unknown>) {
  ...
  (node as unknown as Record<string, unknown>)["~resource"] = "CacheForRedis";
  (node as unknown as Record<string, unknown>)["~iconDataUrl"] = cache_for_redisIcon;
  return node;
}

export function CosmosDb(label?: string, options?: Record<string, unknown>) {
  const node = _Database(label ?? "CosmosDb", options);
  (node as unknown as Record<string, unknown>)["~resource"] = "CosmosDb";
  (node as unknown as Record<string, unknown>)["~iconDataUrl"] = cosmos_dbIcon;
  return node;
}
...
export function DataFactory(label?: string, options?: Record<string, unknown>) {
  ...
  (node as unknown as Record<string, unknown>)["~resource"] = "DataFactory";
  (node as unknown as Record<string, unknown>)["~iconDataUrl"] = data_factoryIcon;
  return node;
}

export function DataLake(label?: string, options?: Record<string, unknown>) {
  const node = _Database(label ?? "DataLake", options);
  (node as unknown as Record<string, unknown>)["~resource"] = "DataLake";
  (node as unknown as Record<string, unknown>)["~iconDataUrl"] = data_lakeIcon;
  return node;
}
...
export function DatabaseForMariadbServers(label?: string, options?: Record<string, unknown>) {
  ...
  (node as unknown as Record<string, unknown>)["~resource"] = "DatabaseForMariadbServers";
  (node as unknown as Record<string, unknown>)["~iconDataUrl"] = database_for_mariadb_serversIcon;
  return node;
}
...
export function DatabaseForMysqlServers(label?: string, options?: Record<string, unknown>) {
  ...
  (node as unknown as Record<string, unknown>)["~resource"] = "DatabaseForMysqlServers";
  (node as unknown as Record<string, unknown>)["~iconDataUrl"] = database_for_mysql_serversIcon;
  return node;
}
...
export function DatabaseForPostgresqlServers(label?: string, options?: Record<string, unknown>) {
  ...
  (node as unknown as Record<string, unknown>)["~resource"] = "DatabaseForPostgresqlServers";
  (node as unknown as Record<string, unknown>)["~iconDataUrl"] =
    database_for_postgresql_serversIcon;
  return node;
}
...
export function ElasticDatabasePools(label?: string, options?: Record<string, unknown>) {
  ...
  (node as unknown as Record<string, unknown>)["~resource"] = "ElasticDatabasePools";
  (node as unknown as Record<string, unknown>)["~iconDataUrl"] = elastic_database_poolsIcon;
  return node;
}
...
export function ManagedDatabases(label?: string, options?: Record<string, unknown>) {
  ...
  (node as unknown as Record<string, unknown>)["~resource"] = "ManagedDatabases";
  (node as unknown as Record<string, unknown>)["~iconDataUrl"] = managed_databasesIcon;
  return node;
}

export function SQLDatabases(label?: string, options?: Record<string, unknown>) {
  const node = _Database(label ?? "SQLDatabases", options);
  (node as unknown as Record<string, unknown>)["~resource"] = "SQLDatabases";
  (node as unknown as Record<string, unknown>)["~iconDataUrl"] = sql_databasesIcon;
  return node;
}
...
export function SQLDatawarehouse(label?: string, options?: Record<string, unknown>) {
  ...
  (node as unknown as Record<string, unknown>)["~resource"] = "SQLDatawarehouse";
  (node as unknown as Record<string, unknown>)["~iconDataUrl"] = sql_datawarehouseIcon;
  return node;
}
...
export function SQLManagedInstances(label?: string, options?: Record<string, unknown>) {
  ...
  (node as unknown as Record<string, unknown>)["~resource"] = "SQLManagedInstances";
  (node as unknown as Record<string, unknown>)["~iconDataUrl"] = sql_managed_instancesIcon;
  return node;
}
...
export function SQLServerStretchDatabases(label?: string, options?: Record<string, unknown>) {
  ...
  (node as unknown as Record<string, unknown>)["~resource"] = "SQLServerStretchDatabases";
  (node as unknown as Record<string, unknown>)["~iconDataUrl"] = sql_server_stretch_databasesIcon;
  return node;
}

export function SQLServers(label?: string, options?: Record<string, unknown>) {
  const node = _Database(label ?? "SQLServers", options);
  (node as unknown as Record<string, unknown>)["~resource"] = "SQLServers";
  (node as unknown as Record<string, unknown>)["~iconDataUrl"] = sql_serversIcon;
  return node;
}

export function SQLVM(label?: string, options?: Record<string, unknown>) {
  const node = _Database(label ?? "SQLVM", options);
  (node as unknown as Record<string, unknown>)["~resource"] = "SQLVM";
  (node as unknown as Record<string, unknown>)["~iconDataUrl"] = sql_vmIcon;
  return node;
}
...
export function VirtualDatacenter(label?: string, options?: Record<string, unknown>) {
  ...
  (node as unknown as Record<string, unknown>)["~resource"] = "VirtualDatacenter";
  (node as unknown as Record<string, unknown>)["~iconDataUrl"] = virtual_datacenterIcon;
  return node;
}
