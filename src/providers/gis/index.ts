...
export function _Gis(label?: string, options?: Record<string, unknown>) {
  ...
  (node as unknown as Record<string, unknown>)["~provider"] = "gis";
  (node as unknown as Record<string, unknown>)["~iconDir"] = "gis";
  return node;
}

export function Gis(label?: string, options?: Record<string, unknown>) {
  const node = _Gis(label ?? "Gis", options);
  (node as unknown as Record<string, unknown>)["~icon"] = "gis.png";
  return node;
}
