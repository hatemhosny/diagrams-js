...
export function _Saas(label?: string, options?: Record<string, unknown>) {
  ...
  (node as unknown as Record<string, unknown>)["~provider"] = "saas";
  (node as unknown as Record<string, unknown>)["~iconDir"] = "saas";
  return node;
}

export function Saas(label?: string, options?: Record<string, unknown>) {
  const node = _Saas(label ?? "Saas", options);
  (node as unknown as Record<string, unknown>)["~icon"] = "saas.png";
  return node;
}
